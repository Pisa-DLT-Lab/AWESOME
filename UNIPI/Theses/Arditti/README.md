...
In questa repository sono presenti gli script di supporto alla tesi triennale in informatica @ UniPi "Modellazione a grafo dei dati Blockchain: rappresentazione e analisi della rete Bitcoin nel graph database Neo4j" di Leonardo Arditti.  
...
Per ragioni di spazio, il dataset originale delle transazioni Bitcoin non è presente in questo repository, ma è disponibile per il download nel seguente repository Zenodo:

https://doi.org/10.5281/zenodo.18938800

I dati scaricati dal repository sono compressi nel formato XZ (https://tukaani.org/xz/) e devono essere decompressi prima dell'utilizzo.
